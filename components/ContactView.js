    ...
    <>
      <section className={style.contact__left}>
        ...
        <div className={style.contact__left_social}>
          <a href="https://www.linkedin.com/in/raul-oliva-27208817b/" target="_blank" rel="noreferrer">
            <Image
              src={LinkedinIcon}
              width="50"
              height="50"
          ...
          <a href="https://www.instagram.com/raul_oliva_cas/" target="_blank" rel="noreferrer">
            <Image
              src={InstagramIcon}
              width="50"
              height="50"
          ...
          <a href="mailto:oliva.raul12@gmail.com" target="_blank" rel="noreferrer">
