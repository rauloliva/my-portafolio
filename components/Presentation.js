    ...
    <>
      <section className={style.presentation__left}>
        ...
        <div className={style.presentation__left_about}>
          <p>
            Welcome to my website where you will be able to know about me, to
            see my portafolio where I show you all of my projects, to know what
            technical skills do I poses, to contact me through my different
            social media accounts or you can download my updated CV.
          </p>
        </div>
