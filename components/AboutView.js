...
const AboutView = () => (
  <>
    ...
    <section className={style.about__right}>
      ...
      <p>
        In June 2019 I started working in Tata Consultancy Services (TCS) as IT
        Support Specialist.
      </p>
      <p>
      ...
      <p>
        My hobbies are playing soccer, sometimes video games, I like traveling,
        programming and learning new things about the technology industy.
      </p>
    </section>
  </>
);
